...
const KEYWORD_PHRASES = /^\b(Identified by|Actor|Recipient|Holder|Claimant|Created by|Obfuscated by|Terminated by|Violated when|Violated|Related to|Syncs with|Holds when|Derived from|Derived externally|Conditioned by|Enforced by|Creates|Obfuscated|Terminates)\b/;
...
export const eflintSyntaxExtensions = [
  eflintLanguage,
  syntaxHighlighting(eflintHighlightStyle),
];