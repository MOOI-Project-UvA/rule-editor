  ...
  <q-card flat bordered class="my-card" v-if="frame">
    ...
    <q-card-section class="q-pa-md q-gutter-sm">
      <div>
        ...
        <FactInputField
          label="Precondition"
          :active="frame.activeField == 'precondition'"
          :facts="frame.precondition ? [frame.precondition] : []"
          @factRemoveClicked="frame.precondition = null"
