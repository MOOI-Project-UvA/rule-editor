...
user-friendly and interactive way. The tool was built using [Vue.js](https://vuejs.org/) and [Quasar](https://quasar.dev/). It is accessible at [https://norm-editor.netlify.app](https://norm-editor.netlify.app/)
